...
// Vendored and slightly adapted from github.com/fvbommel/util/blob/master/sortorder/natsort.go
// I wrote my own alphanumeric/natural sort, but it turned out to be inferior to this one.
// Limitations (deliberate tradeoffs for speed and simplicity):
//   - only ASCII digits (0-9) are considered
//   - does not understand signs, scientific notation, or floating point representations
